...
function randomizedMessage() {
    ...
    //final message 
    idea.innerHTML = `Make a ${randomGenre} type beat using ${randomInstrument} for main melody and with ${randomBase}. Beat should be ${randomVibe}. \n${bpmToUse}`;
}
...
function greetings() {
    ...
    greeting.innerHTML = greetings[Math.floor(Math.random() * 10)];

    
}

button.addEventListener("mousedown", greetings);

button.addEventListener("mouseup", randomizedMessage);